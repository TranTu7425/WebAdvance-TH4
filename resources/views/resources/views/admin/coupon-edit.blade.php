                                ...
                                <div class="wg-box">
                                    <form class="form-new-product form-style-1" method="POST" action="{{ route('admin.coupon.update') }}">
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Nhập mã giảm giá" name="code" tabindex="0" value="{{ $coupon->code }}" aria-required="true" required="">
                                        </fieldset>
                                        @error('code')
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Nhập giá trị" name="value" tabindex="0" value="{{ $coupon->value }}" aria-required="true" required="">
                                        </fieldset>
                                        @error('value')
                                            <span class="alert alert-danger text-center">{{ $message }}</span>
                                        @enderror
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Nhập giá trị giỏ hàng" name="cart_value" tabindex="0" value="{{ $coupon->cart_value }}" aria-required="true"
                                                required="">
                                        </fieldset>
                                        @error('cart_value')
                                            <span class="alert alert-danger text-center">{{ $message }}</span>
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="date" placeholder="Chọn ngày hết hạn" name="expiry_date" tabindex="0" value="{{ $coupon->expiry_date }}" aria-required="true"
                                                required="">
                                        </fieldset>
                                        @error('expiry_date')
                                            <span class="alert alert-danger text-center">{{ $message }}</span>
